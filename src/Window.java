...
public class Window extends JFrame implements ActionListener {
	...
	private JLabel lblMonstre = new JLabel("Monstre : ");
	...
	public void WindowB1() {
		...
		Nourriture.setBorderPainted(true);
		...
		Medicament.setBorderPainted(true);
		...
		Cuisinier.setBorderPainted(true);
		//RAND
		int mini = 0 ,max=1;
	...
	// JButton PPS
		...
		monstre_display.setBounds(867, 79, 145, 67);
	...
	public void deplacement(char s) {
		for (int t = 0; t < jeu.nbIndividu(); t++) {
			if (jeu.getIndividu(t) instanceof Monstre
					&& jeu.getIndividu(t).getPosition() != jeu.monJoueur.getPosition()) {
				if (jeu.monJoueur.getPosition().getPorte(s).getFermer()) {
					...
					if (jeu.monJoueur.getPosition().getPorte(s).getFermer()) {
						//System.out.println("Porte fermée avec la clé numero : "+ jeu.monJoueur.getPosition().getPorte(s).getNumero());
						label.setText("Porte fermée avec la clé numero : "+ jeu.monJoueur.getPosition().getPorte(s).getNumero());
					}
